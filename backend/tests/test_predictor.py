...
class TestPredictor:
    def test_prediction_returns_required_keys(self, predictor):
        patient = {
            "Age": 72, "Gender": 0, "AppointmentLeadTimeDays": 14,
            "SMSReceived": 0, "PriorDNACount": 3, "Hypertension": 1,
            "Diabetes": 0, "Alcoholism": 0, "Disability": 0, "IMDDecile": 2,
        }
    ...
    def test_probability_range(self, predictor):
        patient = {
            "Age": 45, "Gender": 1, "AppointmentLeadTimeDays": 7,
            "SMSReceived": 1, "PriorDNACount": 0, "Hypertension": 0,
            "Diabetes": 0, "Alcoholism": 0, "Disability": 0, "IMDDecile": 7,
        }
        result = predictor.predict(patient)
    ...
    def test_risk_tier_values(self, predictor):
        patient = {
            ...
            "SMSReceived": 1, "PriorDNACount": 0, "Hypertension": 0,
            "Diabetes": 0, "Alcoholism": 0, "Disability": 0, "IMDDecile": 8,
        }
        result = predictor.predict(patient)
    ...
    def test_shap_values_structure(self, predictor):
        patient = {
            "Age": 80, "Gender": 0, "AppointmentLeadTimeDays": 21,
            "SMSReceived": 0, "PriorDNACount": 5, "Hypertension": 1,
            "Diabetes": 1, "Alcoholism": 0, "Disability": 1, "IMDDecile": 1,
        }
        result = predictor.predict(patient)
    ...
    def test_high_risk_patient(self, predictor):
        patient = {
            "Age": 85, "Gender": 0, "AppointmentLeadTimeDays": 30,
            "SMSReceived": 0, "PriorDNACount": 8, "Hypertension": 1,
            "Diabetes": 1, "Alcoholism": 1, "Disability": 1, "IMDDecile": 1,
        }
        result = predictor.predict(patient)
    ...
    def test_low_risk_patient(self, predictor):
        patient = {
            "Age": 30, "Gender": 1, "AppointmentLeadTimeDays": 1,
            "SMSReceived": 1, "PriorDNACount": 0, "Hypertension": 0,
            "Diabetes": 0, "Alcoholism": 0, "Disability": 0, "IMDDecile": 10,
        }
        result = predictor.predict(patient)
        assert result["probability"] < 0.5
