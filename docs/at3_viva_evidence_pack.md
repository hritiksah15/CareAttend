...
| 12:30-13:30 | Testing and QA | Run or show evidence for pytest, Flutter analyze/test, JS syntax, dashboard smoke, sample CSV tests. | 241 backend tests and 33 Flutter tests pass; key risk areas have automated coverage. |
