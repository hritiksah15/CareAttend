...
| 12:30-13:30 | Testing and QA | Run or show evidence for pytest, Flutter analyze/test, JS syntax, dashboard smoke, sample CSV tests. | 242 backend tests and 38 Flutter tests pass; key risk areas have automated coverage. |
